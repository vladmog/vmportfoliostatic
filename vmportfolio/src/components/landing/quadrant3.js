...
const selectedWorks = [
  {
    name: "Event Horizon",
    body:
      "A solo project. Event Horizon is an event organizer for users with differing and conflicting schedules. The app allows any user to invite multiple other users to input their availabilities, quickly identify common openings, and plan for prospective events. ",
    techStack: [
      "React JS",
      "React-Router",
      "Figma",
    ...
    beGithub: "https://github.com/vladmog/event-horizon-be",
    feGithub: "https://github.com/vladmog/event-horizon-fe",
    linkUrl: "https://master.d2mghrfmlzseon.amplifyapp.com/",
  },
  {
    name: "Tagger",
    body:
      "An email client whose data-science-infused search returns emails to queries without the need for exact word matches. As the team lead, solely responsible for coordinating group efforts and building group-dynamics. Led the team through the research and integration phases of the IMAP protocol without prior experience with the technology",
    techStack: [
      "React JS",
      "React-Router",
      "Axios",
  ...
  },
  {
    ...
    body:
      "PriceMyAirbnb is a software solution to the problem of properly pricing Airbnb listings. Using a database of United-States AirBnb listings and data science calculations, the app lays out the financial landscape of users’ locations. This allows them to see where they stand and make informed choices on their properties.",
    techStack: [
      "React JS",
      "React-Router",
      "Axios",
    ...
    beGithub:
      "https://github.com/Lambda-School-Labs/airbnb-unit-price-analysis-be",
    feGithub:
      "https://github.com/Lambda-School-Labs/airbnb-unit-price-analysis-fe",
...
const Quadrant3 = () => (
  <S.Container>
    {selectedWorks.map(selectedWork => {
      return <SelectedWork selectedWork={selectedWork} />
    })}
  </S.Container>
)
